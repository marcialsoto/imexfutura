...
if($cl_redata['singlebloglayout'] == 'fullwidth')
    $spancontent = 12;
else 
    $spancontent = 9;
...
<section id="content" class="<?php echo esc_attr($cl_redata['singlebloglayout']) ?>"  style="background-color:<?php echo (!empty($cl_redata['page_content_background']))?esc_attr($cl_redata['page_content_background']):'#ffffff'; ?>;">
        
        <div class="container" id="blog">
            <div class="row">

            <?php if($cl_redata['singlebloglayout'] == 'sidebar_left') get_sidebar() ?>   
            ...
            <?php if($cl_redata['singlebloglayout'] == 'sidebar_right') get_sidebar() ?>  
