        ...
        function render() {
            ...
            echo '<div id="import_export_default_section_group' . '">';
	            ...
	            echo '<div class="opt_field">';
	            	...
	            	echo '<select id="import_type" name="import_type"><option value="all">All</option><option value="content">Content</option><option value="options">Theme Options</option><option value="widgets">Widgets</option></select>';
	            echo '</div>';
