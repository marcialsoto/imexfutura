...
if (!class_exists("Redux_Framework_sample_config")) {
    ...
    class Redux_Framework_sample_config {
        ...
        public function setSections() {
            ...
            $customize_title = sprintf(__('Customize', 'codeless-admin').'&#8220;%s&#8221;', $this->theme->display('Name'));
            ?>
            ...
            <?php echo $this->theme->display('Name'); ?>
                ...
                <div>
                    <ul class="theme-info">
                        <li><?php printf(__('By %s', 'codeless-admin'), $this->theme->display('Author')); ?></li>
                        <li><?php printf(__('Version %s', 'codeless-admin'), $this->theme->display('Version')); ?></li>
                        <li><?php echo '<strong>' . __('Tags', 'codeless-admin') . ':</strong> '; ?><?php printf($this->theme->display('Tags')); ?></li>
                    </ul>
                    <p class="theme-description"><?php echo $this->theme->display('Description'); ?></p>
                <?php
                if ($this->theme->parent()) {
                    printf(' <p class="howto">' . __('This child theme requires its parent theme, %2$s.', 'codeless-admin') . '</p>', 'http://codex.wordpress.org/Child_Themes', $this->theme->parent()->display('Name'));
                }
                ?>
                ...
                'fields' => array(
                    ...
                    /*array(
                        ...
                        'options' => array(
                            'header_1' => array(
                                'alt' => 'Header 1', 
                                'img' => 'http://localhost/test/wp-content/themes/Avada/images/patterns/header1.jpg',
                                'presets' => array(
                                    
                                    /*'menu_padding' => array('padding-left' => '5px', 'padding-right' => "5px"),
                                    'menu_margin' => array('margin-left' => '0px', 'margin-right' => "0px"),
                                    'background_dropdown' => '#222',
                                    'header_height' => '90px',
                                    'dropdown_border_color' => '#222',
                            ...
                            'header_2' => array(
                                ...
                                'presets' => array(
                                    ...
                                    /*'menu_padding' => array('padding-left' => '10px', 'padding-right' => "10px"),
                                    'menu_margin' => array('margin-left' => '0px', 'margin-right' => "0px"),
                                    'background_dropdown' => '#fff',
                                    'header_height' => '90px',
        ...
        public function setHelpTabs() {
            ...
            /*$this->args['help_tabs'][] = array(
                'id' => 'redux-opts-1',
                'title' => __('Theme Information 1', 'codeless-admin'),
                'content' => '<p>'.__('This is the tab content, HTML is allowed.', 'codeless-admin').'</p>'
            );

            $this->args['help_tabs'][] = array(
                'id' => 'redux-opts-2',
                'title' => __('Theme Information 2', 'codeless-admin'),
                'content' => '<p>'.__('This is the tab content, HTML is allowed.', 'codeless-admin').'</p>'
            );*/

            // Set the help sidebar
            $this->args['help_sidebar'] = '<p>'.__('This is the sidebar content, HTML is allowed.', 'codeless-admin').'</p>';
        }
        ...
        public function setArguments() {
            ...
            if (!isset($this->args['global_variable']) || $this->args['global_variable'] !== false) {
                ...
                $this->args['intro_text'] = sprintf('<p>'.__('Codeless has been quietly but consistently building a powerhouse portfolio of web site design and marketing success.', 'codeless-admin').' </p>', $v);
            } else {
                $this->args['intro_text'] = '<p>'.__('Codeless has been quietly but consistently building a powerhouse portfolio of web site design and marketing success. ', 'codeless-admin').'</p>';
            }

            // Add content after the form.
            $this->args['footer_text'] = __('', 'codeless-admin');
        }
